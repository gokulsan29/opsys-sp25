...
- (c) The response time and turnaround time, averaged across all jobs.
- (d) The percent utilization of the system over the entire schedule.
...
- Starting at time 5, Job B wants to run for 1 time unit, then block for 11 time units, repeating a total of three times.
